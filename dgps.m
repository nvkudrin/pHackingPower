...
%mcout_se_cluster = reshape(mcout_se_cluster, 8, 1000000);
%mcout_se_cluster = mcout_se_cluster(1:5, :);
%mcout_bias_cluster = mcout_bias_cluster(1:5, :);
rng(12345)
